...
EEZ_family_features = read.csv("EEZ_features_family.txt") # add family as col1 label  b/c woulnd't accept same format as species txt file
EEZ_F_F = data.frame(EEZ_family_features)
head(EEZ_F_F)
...
EEZ_F_F_pca = prcomp(EEZ_F_F[2:4], scale=TRUE) # [2:4] SELECT 3 NUMERIC COLUMNS - NOT FAMILY B/C OF ERROR
summary(EEZ_F_F_pca)
